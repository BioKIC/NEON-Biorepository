...
<body>
	...
	<div id="innertext">
		...
		<article>
			...
			<p>While the main NEON data portal will often include observational data from data products relevant to a sample, the NEON Biorepository data portal collates all occurence information for those samples that are available for research.</p>
		</article>

		<article>
			<h3 class="anchor" id="h.umiu0nb3f0np">How do I search for samples?</h3>
			<p>There are several different ways that you can search for samples. This <a href="https://www.youtube.com/watch?v=c_-v0LTgBY0" target="_blank" rel="noopener noreferrer">video</a> provides a detailed explanation of some of the major ways users interact with our portal.
		</article>
