...
<div id="innertext">
	<h1 style="text-align:center;">Sample Use Policy</h1>
		...
		<article>
			...
			<p> Here we describe the expectations and requirements of researchers engaged in using samples from the NEON Biorepository to ensure effective stewardship of these valuable samples to maximize their scientific impact.</p>
			<ul>
				...
				<li><b>Researchers using NEON Biorepository samples must provide all resulting sample-associated data to NEON for publication via the <a href="../neon/search/index.php" target="_blank">NEON Sample Portal</a> for public use within 2 years of sample receipt or upon publication, whichever comes first.</b> Special exceptions regarding data embargos, sensitive data, or extensions may be arranged in writing. This data includes, but is not limited to, species determinations, re-identifications, taxonomic updates, corrections to any existing published data, (raw and derived specimen-level) images and other media files, and links to externally-hosted genetic and genomic sequence data. Instructions for providing these data to the NEON Biorepository will be outlined in the Sample Use Agreement. Guidelines for attribution and licensing of researcher-contributed data default to those listed in the Citation Requirements for <a href="cite.php#h.3" target="_blank">Data-Only Use</a> and <a href= "misc.cite.php#h.5" target="_blank">Using and Citing Sample Images</a> policies. Future users of requestor-derived data will be encouraged to cite the original publications, which will be linked to associated sample records within the NEON Biorepository Sample Portal. The NEON Biorepository retains ownership of all images and media.</li>

				<li><b>Researchers must follow all requirements listed in the <a href="cite.php" target="_blank">Acknowledging and Citing the NEON Biorepository</a> policy</b>. Specimens used in publications, reports, or presentations should be listed within the main text and/or supplemental information as outlined in the Sample Use Agreement.</li>
