...
<div id="innertext">
	...
	<ol>
		...
		<li><a href="#citations">NEON Biorepository Citation Requirements</a></li>
	</ol>
	<hr>
		...
		<article>
			...
			<ul>
				...
				<li>Provide quotes for service fees, if applicable. Note that significantly more time may be required when additional NEON Biorepository personnel would be required to complete the proposed work.</li>
			</ul>
