...
<body>
	...
	<div id="innertext">
		...
		<article>
			...
			<p>Associated sample data must be cited following the <a href="#h.3">Citation Requirements for Data-Only Use</a> as described above. To support accurate sample data citations, the Sample Use Agreement will include a unique download link that will allow users to retrieve the most current associated data for their requested samples provided through the NEON Biorepository Sample Portal. If additional data are obtained directly from the <a href="https://data.neonscience.org/data-products/explore">NEON Data Portal</a> (e.g., via download, API access, or programmatic tools), the relevant NEON Data Product(s) must also be cited in accordance with <a href="https://www.neonscience.org/data-samples/guidelines-policies/citing#citing-data">NEON data citation guidance</a>.</p>
		</article>
