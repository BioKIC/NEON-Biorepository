...
class Image_Barcode2_Driver_Code128 extends Image_Barcode2_Common implements Image_Barcode2_Driver
{
    ...
    public function draw()
    {
        ...
        $this->targetWidth = 246;
        $this->targetHeight = 84;
        ...
        // Determine width of a single unit to fit the desired width
        $unitWidth = $this->targetWidth / $totalUnits;
        $barcodewidth = $this->targetWidth;
        $barcodelongheight = $this->targetHeight - $writer->imagefontheight($fontsize) + 1;
        ...
        $img = $writer->imagecreate(
            $barcodewidth,
            $barcodelongheight + $writer->imagefontheight($fontsize) + 15
        );
