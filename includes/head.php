...
<!--neon react links-->
<!--React last updated: 7/13/2026, 11:27:18 AM-->
<meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no"/><meta name="theme-color" content="#000000"/><link rel="manifest" href="<?php echo $CLIENT_ROOT; ?>/neon-react/manifest.json"/><link rel="shortcut icon" href="<?php echo $CLIENT_ROOT; ?>/neon-react/favicon.ico?v=201912"/><link rel="preconnect" href="https://www.neonscience.org" crossorigin="anonymous"/><link rel="stylesheet" data-meta="drupal-fonts" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/drupal-fonts.css"/><link rel="stylesheet" data-meta="drupal-theme" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/drupal-theme.c12ee9878c2546595e186d8f3917da9c.min.css"/><link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons"/><link rel="stylesheet" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/webpack-overrides.css"/><script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script><script>let gaInitialized = false;
    ...
    function loadGAScript() {
        return new Promise(resolve => {
            ...
            s.async = true;
            s.src = 'https://www.googletagmanager.com/gtag/js?id=G-6M1F2QCBWJ';
    ...
    async function initGA() {
        ...
        window.pendingGAEvents.forEach(args => {
            gtag(...args);
        });
        window.pendingGAEvents = [];
        ...
        document
            .querySelectorAll('.search-api-form form')
            .forEach(form => {
                form.addEventListener('submit', e => {
                    const query = e.target.querySelector('[name="title"]')?.value?.trim();
        
                    if (!query) return;
        
                    gtag('event', 'neon-search', {
                        search_term: query
                    });
                });
            });
    ...
    async function trackInteraction(type) {
        ...
        if (type === 'mousemove' && firstTime != null) {
            const displacement = Math.hypot(lastX - startX, lastY - startY);
    
            gtag('event', 'mouse_metrics', {
                moves,
                distance: Math.round(distance),
                duration: Math.round(lastTime - firstTime),
                velocity: Math.round(distance / Math.max(lastTime - firstTime, 1)),
                max_step: Math.round(maxStep),
                straightness: +(displacement / Math.max(distance, 1)).toFixed(2)
            });
        }
    }
    ...
    window.addEventListener('mousemove', e => {
        if (!trackingMouse || interactionTracked) return;
    ...
    });</script><script>window.NEON_SERVER_DATA="__NEON_SERVER_DATA__"</script><link href="<?php echo $CLIENT_ROOT; ?>/neon-react/static/css/main.dfee6011.css" rel="stylesheet">
