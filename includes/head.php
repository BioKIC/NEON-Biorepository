...
<!--neon react links-->
<!--React last updated: 5/12/2026, 9:58:52 AM-->
<meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no"/><meta name="theme-color" content="#000000"/><link rel="manifest" href="<?php echo $CLIENT_ROOT; ?>/neon-react/manifest.json"/><link rel="shortcut icon" href="<?php echo $CLIENT_ROOT; ?>/neon-react/favicon.ico?v=201912"/><link rel="preconnect" href="https://www.neonscience.org" crossorigin="anonymous"/><link rel="stylesheet" data-meta="drupal-fonts" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/drupal-fonts.css"/><link rel="stylesheet" data-meta="drupal-theme" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/drupal-theme.c12ee9878c2546595e186d8f3917da9c.min.css"/><link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons"/><link rel="stylesheet" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/webpack-overrides.css"/><script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script><script async src="https://www.googletagmanager.com/gtag/js?id=G-6M1F2QCBWJ"></script><script>let gaInitialized=!1;function initGA(){function t(){window.dataLayer.push(arguments)}gaInitialized||(gaInitialized=!0,window.dataLayer=window.dataLayer||[],window.gtag=t,t("js",new Date),t("config","G-6M1F2QCBWJ",{send_page_view:!1}),document.addEventListener("click",(function(n){const e=n.target;t("event","ui_click",{tag:e.tagName||"",text:(e.innerText||"").trim().substring(0,100),id:e.id||"",page_path:window.location.pathname})})))}initGA();let interactionTracked=!1;function trackInteraction(t){interactionTracked||window.gtag&&(interactionTracked=!0,gtag("event","interaction",{interaction_type:t}),gtag("event","page_view",{page_path:window.location.pathname}))}window.addEventListener("mousemove",(()=>trackInteraction("mousemove")),{once:!0}),window.addEventListener("scroll",(()=>trackInteraction("scroll")),{once:!0}),window.addEventListener("click",(()=>trackInteraction("click")),{once:!0}),window.addEventListener("keydown",(()=>trackInteraction("keydown")),{once:!0}),window.addEventListener("touchstart",(()=>trackInteraction("touchstart")),{once:!0})</script><script>window.NEON_SERVER_DATA="__NEON_SERVER_DATA__"</script><link href="<?php echo $CLIENT_ROOT; ?>/neon-react/static/css/main.dfee6011.css" rel="stylesheet">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        reactScript.src = '<?php echo $CLIENT_ROOT; ?>/neon-react/static/js/main.666b731f.js';
