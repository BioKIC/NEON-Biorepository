...
<script>
    document.addEventListener('DOMContentLoaded', function() {
		...
		if(empty($DEACTIVATE_REACT)){
            ...
            reactScript.src = '<?php echo $CLIENT_ROOT; ?>/neon-react/static/js/main.ff952aef.js';
