...
<!--neon react links-->
<!--React last updated: 7/16/2026, 5:28:49 PM-->
<meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no"/><meta name="theme-color" content="#000000"/><link rel="manifest" href="<?php echo $CLIENT_ROOT; ?>/neon-react/manifest.json"/><link rel="shortcut icon" href="<?php echo $CLIENT_ROOT; ?>/neon-react/favicon.ico?v=201912"/><link rel="preconnect" href="https://www.neonscience.org" crossorigin="anonymous"/><link rel="stylesheet" data-meta="drupal-fonts" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/drupal-fonts.css"/><link rel="stylesheet" data-meta="drupal-theme" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/drupal-theme.c12ee9878c2546595e186d8f3917da9c.min.css"/><link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons"/><link rel="stylesheet" href="<?php echo $CLIENT_ROOT; ?>/neon-react/assets/css/webpack-overrides.css"/><script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script><script>let gaInitialized=!1;function loadGAScript(){return new Promise((t=>{if(document.querySelector("script[data-ga-loader]"))return void t();const e=document.createElement("script");e.async=!0,e.src="https://www.googletagmanager.com/gtag/js?id=G-6M1F2QCBWJ",e.setAttribute("data-ga-loader","true"),e.onload=t,document.head.appendChild(e)}))}async function initGA(){gaInitialized||(gaInitialized=!0,await loadGAScript(),window.dataLayer=window.dataLayer||[],window.gtag=function(){window.dataLayer.push(arguments)},gtag("js",new Date),gtag("config","G-6M1F2QCBWJ",{send_page_view:!1}),gtag("event","page_view",{page_path:window.location.pathname,page_location:window.location.href,page_title:document.title}),window.pendingGAEvents.forEach((t=>{gtag(...t)})),window.pendingGAEvents=[],document.addEventListener("click",(t=>{const e=t.target;gtag("event","ui_click",{tag:e.tagName||"",text:(e.innerText||"").trim().substring(0,100),id:e.id||"",page_path:window.location.pathname})})),document.querySelectorAll(".search-api-form form").forEach((t=>{t.addEventListener("submit",(t=>{const e=t.target.querySelector('[name="title"]')?.value?.trim();e&&gtag("event","neon-search",{search_term:e})}))})))}window.pendingGAEvents=[];let firstTime,lastTime,startX,startY,lastX,lastY,gestureTimer,interactionTracked=!1,moves=0,distance=0,maxStep=0;async function trackInteraction(t){interactionTracked||(interactionTracked=!0,await initGA(),gtag("event","interaction",{interaction_type:t}))}function sendMouseMetrics(){if(null==firstTime||null==lastTime)return;const t=Math.hypot(lastX-startX,lastY-startY),e=["event","mouse_metrics",{moves:moves,distance:Math.round(distance),duration:Math.round(lastTime-firstTime),velocity:Math.round(1e3*distance/Math.max(lastTime-firstTime,1)),max_step:Math.round(maxStep),straightness:+(t/Math.max(distance,1)).toFixed(2)}];gaInitialized?gtag(...e):window.pendingGAEvents.push(e)}window.addEventListener("click",(()=>{trackInteraction("click")}),{once:!0}),window.addEventListener("keydown",(()=>{trackInteraction("keydown")}),{once:!0}),window.addEventListener("touchstart",(()=>{trackInteraction("touchstart")}),{once:!0});let mouseMoves=0;window.addEventListener("mousemove",(()=>{mouseMoves++,2===mouseMoves&&trackInteraction("mousemove")})),window.addEventListener("mousemove",(t=>{const e=performance.now();if(null==firstTime)return firstTime=lastTime=e,startX=lastX=t.clientX,void(startY=lastY=t.clientY);const a=Math.hypot(t.clientX-lastX,t.clientY-lastY);moves++,distance+=a,maxStep=Math.max(maxStep,a),lastX=t.clientX,lastY=t.clientY,lastTime=e,clearTimeout(gestureTimer),gestureTimer=setTimeout((()=>{sendMouseMetrics(),moves=0,distance=0,maxStep=0,firstTime=null,lastTime=null,startX=startY=null,lastX=lastY=null}),150)}))</script><script>window.NEON_SERVER_DATA="__NEON_SERVER_DATA__"</script><link href="<?php echo $CLIENT_ROOT; ?>/neon-react/static/css/main.dfee6011.css" rel="stylesheet">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
		...
		if(empty($DEACTIVATE_REACT)){
            ...
            reactScript.src = '<?php echo $CLIENT_ROOT; ?>/neon-react/static/js/main.e5529395.js';
